...
Each section shows a vulnerable pattern and its secure replacement, illustrated with a representative web-app stack (component-based UI, Express-style routing, MongoDB/Mongoose data layer, JWT auth) — adapt the syntax to the project's actual stack; the underlying vulnerability and fix generalize.
