...
- **Raw-HTML injection API security note** (example: React's `dangerouslySetInnerHTML`): https://react.dev/reference/react-dom/components/common#dangerously-setting-the-inner-html
