...
### Bundled Project Diagnostic Script

This skill ships a one-shot diagnostic that reports TypeScript/Node versions, tsconfig strictness, tooling, monorepo setup, type errors, `any`/assertion usage, and compilation performance. Run it from the project root:

```bash
python ${CLAUDE_PLUGIN_ROOT}/skills/typescript-expert/scripts/ts_diagnostic.py
```
